# Contributing to `auto-tetris`

:+1::tada: First off, thanks for taking the time to contribute! :tada::+1:

The following is a set of guidelines for contributing to [auto-tetris](https://github.com/jserv/auto-tetris)
...
Visit our [Issues page on GitHub](https://github.com/jserv/auto-tetris/issues) to search and submit.
